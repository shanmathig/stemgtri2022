...
# import algorithms
from directed_graph import KL_init
...
def KL_data():
    directory_path = KL_init.main() # runs KL algorithm
    return jsonify(directory_path) # returns path of JSON file generated by KL algorithm
